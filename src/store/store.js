        ...
        "slots": [
          {
            "runes": [
              ...
              },
              {
                ...
                "longDesc": "Gain 110% Attack Speed when you attack an enemy champion for up to 3 attacks.<br><br>No more than 2s can elapse between attacks or this effect will end.<br><br>Cooldown: 4s out of combat.<br><br><rules>Attack resets increase the attack limit by 1.<br>Allows you to temporarily exceed the attack speed limit.</rules>"
              }
            ]
          },
          {
            "runes": [
              {
                ...
                "longDesc": "Damaging champions with <b>impaired movement or actions</b> deals 8 - 40 bonus true damage (based on level).<br><br>Cooldown: 4s<br><rules>Activates on damage occurring after the impairment.</rules>"
              },
              {
                "id": 8139,
                "key": "TasteOfBlood",
            ...
            "runes": [
              {
                ...
                "name": "Zombie Ward",
                "shortDesc": "<lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Takedown'>Takedowns</lol-uikit-tooltipped-keyword> on enemy Wards cause friendly Zombie Wards to sprout from their corpses. In addition, damaging a Champion after destroying a Ward inflicts bonus magic damage.",
                "longDesc": "<lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Takedown'>Takedowns</lol-uikit-tooltipped-keyword> on enemy Wards cause friendly Zombie Wards to sprout from their corpses. In addition, damaging a Champion after destroying a Ward inflicts <scaleLevel>30 - 90</scaleLevel> bonus magic damage (based on level).<br><br>Zombie Wards are visible, last for 120s and do not count towards your ward limit."
              },
              {
                "id": 8120,
                "key": "GhostPoro",
                ...
                "name": "Ghost Poro",
                "shortDesc": "Entering brush swaps your current Trinket for a Ghost Poro. The Ghost Poro can be placed in brush and grants vision until discovered. <br><br>While either you or your poro is in <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_EnemyTerritory'>enemy territory</lol-uikit-tooltipped-keyword>, gain <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'>adaptive</lol-uikit-tooltipped-keyword> force.",
                "longDesc": "Entering brush temporarily swaps your Trinket for a Ghost Poro, which grants vision for 300s when placed in brush. Nearby enemy champions scare the Ghost Poro away.<br><br>While either you or your Ghost Poro is in <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_EnemyTerritory'>enemy territory</lol-uikit-tooltipped-keyword>, gain 5-20 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'>adaptive</lol-uikit-tooltipped-keyword> force (based on level).<br><br>Cooldown: 60s if Poro is scared away."
              },
              {
                "id": 8138,
            ...
            "runes": [
              {
                ...
                "longDesc": "Heal for a percentage of the damage dealt by your abilities.<br>Healing: 1.5% + 2.5% per <i>Bounty Hunter</i> stack. <br><br><i>Bounty Hunter</i> stacks are earned the first time you get a takedown on each enemy champion.<br><rules><br>Healing reduced to one third for Area of Effect abilities.</rules>"
              },
              {
                "id": 8134,
                "key": "IngeniousHunter",
                ...
                "longDesc": "Gain 15% <b>Active Item CDR</b> plus an additional 5% per <i>Bounty Hunter</i> stack (includes Trinkets).<br><br><i>Bounty Hunter</i> stacks are earned the first time you get a takedown on each enemy champion."
              },
              {
                "id": 8105,
                ...
                "longDesc": "Gain 8 <b>out of combat Movement Speed</b> plus 8 per <i>Bounty Hunter</i> stack.<br><br><i>Bounty Hunter</i> stacks are earned the first time you get a takedown on each enemy champion."
              },
              {
                "id": 8106,
                "key": "UltimateHunter",
                ...
                "longDesc": "Your ultimate gains 5% <b>reduced cooldown,</b> plus an additional 2% per <i>Bounty Hunter</i> stack.<br><br><i>Bounty Hunter</i> stacks are earned the first time you get a takedown on each enemy champion."
              }
            ]
          }
        ]
          ...
          },
          {
            "runes": [
              ...
              },
              {
                ...
                "shortDesc": "Gain a free Biscuit every 3 min, until 12 min. Consuming or selling a Biscuit permanently increases your max mana and restores health and mana.",
                "longDesc": "Biscuit Delivery: Gain a Total Biscuit of Everlasting Will every 3 mins, until 12 min.<br><br>Biscuits restore 15% of your missing health and mana. Consuming or selling a Biscuit permanently increases your mana cap by 40. <br><br><i>Manaless:</i> Champions without mana restore 20% missing health instead."
              }
            ]
          },
          {
            "runes": [
              ...
              },
              {
                ...
                "longDesc": "Consuming a potion or biscuit grants 50% of its health or mana restoration immediately, but puts that consumable on a short cooldown. In addition, gain 5% Movement Speed while under their effects.<br><br>Cooldown: equal to the duration of the consumable."
              }
            ]
          }
        ]
        ...
        "slots": [
          {
            "runes": [
              ...
              },
              {
                ...
                "longDesc": "Attacking and moving builds Energy stacks. At 100 stacks, your next attack is Energized<br><br>Energized attacks heal you for 3 - 60 (+0.3 Bonus AD, +0.3 AP) and grant +20% movement speed for 1s.<br><br>Healing from minions is 20% effective for Ranged Champions."
              },
              {
                "id": 8010,
                "key": "Conqueror",
                ...
                "name": "Conqueror",
                "shortDesc": "Gain stacks of adaptive force when attacking enemy champions. After reaching 5 stacks, convert a portion of your damage to true and heal for that amount.",
                "longDesc": "Attacks or spells that deal damage to an enemy champion grant 2-6 Adaptive Force (based on level) for 2s (8s for melee). Stacks up to 5 times.<br><br>When fully stacked, 10% of your damage is converted to True Damage and you heal for that amount."
              }
            ]
          },
          {
            "runes": [
              {
                ...
                "longDesc": "Excess healing on you becomes a shield, for up to 10 <scaleHealth>(+10% Max Health)</scaleHealth>.<br><br>Shield is built up from 20 to 100% of excess healing from yourself or any ally."
              },
              {
                "id": 9111,
                "key": "Triumph",
          ...
          },
          {
            "runes": [
              ...
              },
              {
                ...
                "shortDesc": "<lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Takedown'>Takedowns</lol-uikit-tooltipped-keyword> on enemies grant permanent<b> Lifesteal</b>. Weaker earlier but stronger later game than other Legend Runes.",
                "longDesc": "Gain 0.6% life steal for every <i>Legend</i> stack (<statGood>max 20 stacks</statGood>).<br><br>Earn progress toward <i>Legend</i> stacks for every champion takedown, epic monster takedown, large monster kill, and minion kill."
              }
            ]
          },
          {
            "runes": [
              ...
              },
              {
                ...
                "longDesc": "Deal 5% to 12% more damage to champions, based on how much more max health they have than you.<br><br><rules>Bonus damage scales up linearly against enemies with 10% to 100% more max health than you.</rules>"
              },
              {
                "id": 8299,
                "key": "LastStand",
            ...
            "runes": [
              {
                ...
                "longDesc": "Charge up a powerful attack against a tower over 3s, while within 600 range of it. The charged attack deals 100 (+30% of your max health) bonus physical damage. <br><br>Cooldown: 45s"
              },
              {
                "id": 8463,
                "key": "FontOfLife",
          ...
          },
          {
            "runes": [
              ...
              },
              {
                ...
                "name": "Bone Plating",
                "shortDesc": "After taking damage from an enemy champion, the next 3 spells or attacks you receive from them deal 25-50 less damage.<br><br><br>Duration: 1.5s<br>Cooldown: 45s",
                "longDesc": "After taking damage from an enemy champion, the next 3 spells or attacks you receive from them deal 25-50 less damage.<br><br><br>Duration: 1.5s<br>Cooldown: 45s"
              }
            ]
          },
          {
            "runes": [
              {
                ...
                "longDesc": "Absorb life essence from monsters or enemy minions that die near you, permanently gaining 3 maximum health for every 8.<br><br>When you've absorbed 120 monsters or enemy minions, gain an additional 2.5% maximum health."
              },
              {
                "id": 8453,
                "key": "Revitalize",
            ...
            "runes": [
              {
                ...
                "longDesc": "Your attacks and abilities send Aery to a target, damaging enemy champions or shielding allies.<br><br>Damage: 10 - 40 based on level (+<scaleAP>0.1 AP</scaleAP> and +<scaleAD>0.15 bonus AD</scaleAD>)<br>Shield: 35 - 80 based on level (+<scaleAP>0.25 AP</scaleAP> and +<scaleAD>0.4 bonus AD</scaleAD>) <br><br>Aery cannot be sent out again until she returns to you."
              },
              {
                "id": 8229,
                "key": "ArcaneComet",
              ...
              },
              {
                ...
                "longDesc": "Hitting an enemy champion with 3 attacks or <b>separate</b> abilities within 3s grants 25 - 40% Movement Speed based on level and 75% Slow Resistance.<br><br>Duration: 3s<br>Cooldown: 15s"
              }
            ]
          },
          {
            "runes": [
              ...
              },
              {
                ...
                "name": "Nimbus Cloak",
                "shortDesc": "Shortly after casting your Ultimate, gain a decaying movement speed increase that lasts for 2.5s and allows you to pass through units.",
                "longDesc": "Shortly after casting your Ultimate, gain a decaying movement speed increase that lasts for 2.5s and allows you to pass through units.<br><br>Increase: 100 Movement Speed<br>Cooldown: 60s, reduced by <b>Cooldown Reduction</b>"
              }
            ]
          },
          {
            ...
            "runes": [
              {
                ...
                "longDesc": "Your next damaging ability hit sets champions on fire dealing 10 - 30 bonus magic damage based on level after 1s.<br><br>Cooldown: 10s"
              },
              {
                "id": 8232,
                "key": "Waterwalking",
